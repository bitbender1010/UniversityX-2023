...
@section('content')
               ...
               <div class="announce-num">1</div>
                       ...
                       <div class="list-of-courses">
                           <div class="loc">Courses > Calculus (MAT 112)</div>
                ...
                <a href="{{ asset('computer-science/100/CSC120/1/coursedetails') }}" class="cc-1">
                       <div class="course-card">
                           ...
                           <div class="course-title ct-sub">Elementary functions of single variable and their graphs, limit and idea of continuity.</div>
                ...
                <div href="#" class="cc-1">
                       <div class="course-card">
                           ...
                           <div class="course-title ct-sub">Differentiation: rate of change, product and quotient rules.</div>
                           <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="right-img" height="30px" viewBox="0 0 24 24" width="30px" fill="#000000"><g><path d="M0,0h24v24H0V0z" fill="none"/></g><g><polygon points="6.23,20.23 8,22 18,12 8,2 6.23,3.77 14.46,12"/></g></svg>
                           <div class="long-line"> </div>
                        </div>
                </div>
                ...
                <div href="#" class="cc-1">
                       <div class="course-card">
                           ...
                           <div class="course-title ct-sub">Differentiation: function of function, implicit functions, differentiation of trigonometric and inverse trigonometric functions.</div>
                           <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="right-img" height="30px" viewBox="0 0 24 24" width="30px" fill="#000000"><g><path d="M0,0h24v24H0V0z" fill="none"/></g><g><polygon points="6.23,20.23 8,22 18,12 8,2 6.23,3.77 14.46,12"/></g></svg>
                           <div class="long-line"> </div>
                        </div>
                </div>
                ...
                <a href="{{ asset('files/CSC/100/mat_112_2015-2016_pastquestion.pdf')}}" download target="_blank">
                       <div class="course-card sub-margin">
                           <!--video icon-->
                          <div class="sm-sub-icon"> <img src="{{ asset('images/pdf-icon.svg')}}"/> </div>
                           <div class="course-title ct-sub">Past questions (2015/16)</div>
